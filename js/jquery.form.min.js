            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function(key, val) {
                        ...
                        html += '<div class="col-md-3"><input type="checkbox" name="rezervare_camera_' + $('*[name="rezervare_tip_camera"]').val() + key + '" class="form-control" value="' + val.etaj + '-' + val.numar + '-' + val.pret_per_zi + '"></div>';
                        html += '</div>';
